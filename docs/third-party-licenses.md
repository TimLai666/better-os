...
- `Cargo.lock` SHA-256: `07c31641c9b8f475c528e6f670eee8390c574ce7a036a4f7600d39ade9024995`.
...
| --- | --- | --- | --- |
| `app-catalog-core` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `app-catalog-platform` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `app-chooser-core` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `app-chooser-gui` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `awake-core` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `awake-gui` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `awake-ipc` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `awake-platform` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `awake-service` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `awake-store` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `awake-tray` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `better-actions` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `better-core` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `better-ui` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `cbindgen` | `0.28.0` | `MPL-2.0` | [crates.io](https://crates.io/crates/cbindgen/0.28.0) |
| `defaults-core` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `defaults-platform` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `defaults-store` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `dwrote` | `0.11.5` | `MPL-2.0` | [crates.io](https://crates.io/crates/dwrote/0.11.5) |
| `files-core` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `files-gui` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `files-operations` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `files-platform` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `files-preview` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `files-search` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `launcher-core` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `launcher-gui` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `launcher-platform` | `0.2.1` | `GPL-3.0-or-later` | workspace |
...
| `manager-cli` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `manager-core` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `manager-daemon` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `manager-gui` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `manager-ipc` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `manager-platform` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `manager-store` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `monitor-actions-linux` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `monitor-cli` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `monitor-collectors-linux` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `monitor-core` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `monitor-export` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `monitor-gui` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `monitor-ipc` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `monitor-service` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `monitor-store` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `monitor-views` | `0.2.1` | `GPL-3.0-or-later` | workspace |
...
| `storage-core` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `storage-platform` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `storage-service` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `touchpad-core` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `touchpad-gesture-service` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `touchpad-gestures` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `touchpad-gui` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `touchpad-platform` | `0.2.1` | `GPL-3.0-or-later` | workspace |
| `touchpad-session` | `0.2.1` | `GPL-3.0-or-later` | workspace |
