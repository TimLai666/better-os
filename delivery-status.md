...
installed. `docs/tickets/47-health-check-file-list.md` has the reasoning, and
the release it needs to reach a machine is a version bump nobody has cut.

No further ticket is cut. Tickets 18 through 45 are done, merged, and released.
