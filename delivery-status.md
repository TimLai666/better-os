...
Ticket 49 is implemented on `ticket-49` and not merged. It is the fifth round
...
`docs/tickets/49-drift-self-heal-and-cli-hang.md` has the reasoning.

Tickets 18 through 48 are done, merged, and released, and `docs/tickets/` holds
nothing else unstarted.
